...
### Download the ADB Wallet

1. Sign in to your **Cloud Account**. Under **Database**, select **Autonomous Transaction Processing**. If you don't see your instance, make sure the **Workload Type** is **Transaction Processing** or **All**.
...
### Download the Oracle Graph Server Software

## **STEP 4:** Upload the Required Files to an OCI Bucket
...
You now have a lab environment setup and ready to be used for the remaining lab steps.
